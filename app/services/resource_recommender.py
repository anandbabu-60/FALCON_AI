...
8. The official dataset source or download URL (only when known)
9. License, approximate size, and domain (or "Not specified")
...
- Prefer official dataset pages (for example, the dataset maintainer,
  benchmark, government, or university host) over third-party mirrors.
- Never fabricate a URL. Use null or "Not specified" when the official
  source cannot be verified from the supplied context.
